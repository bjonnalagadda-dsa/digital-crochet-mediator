// This file is intentionally empty — PatternContext lives in hooks/PatternContext.tsx.
// The default export below silences Expo Router's "missing default export" warning.
...
export function PatternProvider({ children }: { children: React.ReactNode }) {
  ...
  // Persist library whenever it changes (after initial load)
  useEffect(() => {
    if (!isLoaded) return;
    saveLibrary(library);
  }, [library, isLoaded]);
